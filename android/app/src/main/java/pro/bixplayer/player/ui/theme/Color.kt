...
// Brand (Bix Player Pro): near-black surfaces with an orange accent. Contrast checked
// against WCAG AA: accent on background 8.7:1, onSurfaceVariant on surfaceVariant 9.4:1,
...
val BixBackground = Color(0xFF050404)
val BixSurface = Color(0xFF141212)
val BixSurfaceVariant = Color(0xFF262222)
