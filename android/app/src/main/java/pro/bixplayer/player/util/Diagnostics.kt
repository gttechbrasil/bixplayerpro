...
class Diagnostics @Inject constructor(
    ...
    fun deviceInfo(): Map<String, String> {
        ...
        return linkedMapOf(
            ...
            // build.prop on cheap boxes lies about the release string; never decide on it.
            "release_reported" to Build.VERSION.RELEASE,
            "security_patch" to (Build.VERSION.SECURITY_PATCH ?: ""),
            "hardware" to Build.HARDWARE,
            "low_ram" to "${DeviceClass.lowRam} (total ${DeviceClass.totalRamMb} MB)",
            "video_decoders" to DeviceClass.videoDecoderSummary(),
